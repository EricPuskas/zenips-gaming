...
// Components
import NewsFeed from "./ReviewsFeed";
  ...
  handleScroll = (e, scrolling, totalPages, page, per) => {
    ...
    if (container && offset && target) {
      ...
      if (result > targetOffset + (container.offsetTop - 700)) {
        this.props.getMoreReviews(per, page + 1);
      }
    }
  };
...
Reviews.propTypes = {
  ...
  getInitReviews: PropTypes.func.isRequired,
