...
// Actions
import { getInitNews, getMoreNews } from "../../../../actions/articleActions";
...
class News extends PureComponent {
  ...
  handleScroll = (e, scrolling, totalPages, page, per) => {
    ...
    if (container && offset && target) {
      ...
      if (result > targetOffset + (container.offsetTop - 700)) {
        this.props.getMoreNews(per, page + 1);
      }
    }
  };
  ...
  render() {
    ...
    init_loading
      ...
      : (main = <NewsFeed articles={articles} />);
    return (
      <div>
...
News.propTypes = {
  ...
  getInitNews: PropTypes.func.isRequired,
