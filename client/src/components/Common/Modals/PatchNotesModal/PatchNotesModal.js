...
class PatchNotesModal extends React.Component {
  ...
  render() {
    ...
    let content;
    const { delete_loading, patch_notes, page } = this.props.patch_notes;
    const { error_loading } = this.state.errors;
    let error_message = this.state.errors.error.error_message;
    if (delete_loading) {
          ...
          <div className="text-center">
            ...
            <Footer>
              <button
                ...
                onClick={() => submitForm(id, patch_notes.length, page)}
              >
          ...
          <div>
            <Body>
              {error_loading ? (
                ...
                <div className="errorMsg">Error: {error_message}</div>
              )}
            </Body>
            <Footer>
              <button
